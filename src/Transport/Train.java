...
public class Train extends Transport {
    ...
    public Train(String brand, String model, int productionYears, String productionCountry, String color, int maxSpeed,
                 double tripPrice, int travelTimeMinutes, String departureStationName,  String endingStation, int amountWagons) {
