...
public class  Car extends Transport {
    ...
    public Car(String brand, String model, int productionYears, String productionCountry,
               String color, float engineVolume, String transmission, String bodyType,
               String registrationNumber, int seats, String tires, Key key, Insurance insurance, int maxSpeed) {
    ...
    public String toString() {
        return "Car: " + "engineVolume = " + engineVolume + ", transmission = " + transmission +
                ", bodyType = " + bodyType + ", registrationNumber = " + registrationNumber +
                ", seats = " + seats + ", tires = " + tires + ", key = " + key + ", insurance = " + insurance + '.';
    }
    ...
    public static class Insurance {
        ...
        public String toString() {
            return "Insurance: " + "expireDay = " + expireDay + ", cost = " + cost +
                    ", number = " + number + '.';
        }
